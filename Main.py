...
main = tkinter.Tk()
main.title("Cooperative Multi-Agent Traffic Monitoring Can Reduce Camera Surveillance")
...
font = ('times', 16, 'bold')
title = Label(main, text='Cooperative Multi-Agent Traffic Monitoring Can Reduce Camera Surveillance')
